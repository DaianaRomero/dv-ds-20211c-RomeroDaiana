...
import ar.edu.davinci.dvds20211cRomeroDaiana.repository.VentaEfectivoRepository;
import ar.edu.davinci.dvds20211cRomeroDaiana.repository.VentaRepository;
import ar.edu.davinci.dvds20211cRomeroDaiana.repository.VentaTarjetaRepository;
...
public class VentaServiceImpl implements VentaService {
	...
	public Venta addItem(Long id, Item item) throws BusinessException {
		...
		if (ventaOptional.isPresent()) {
			...
			throw new BusinessException("Venta no existe");
		}
	...
	private Venta getVenta(Long id) throws BusinessException {
		Optional<Venta> ventaOptional = ventaRepository.findById(id);
		if (ventaOptional.isPresent()) {
			return ventaOptional.get();
		} else {
			throw new BusinessException("Venta no encotrado");
		}
	}
